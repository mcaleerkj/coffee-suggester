...
const buttonVariants = cva(
  'inline-flex items-center justify-center whitespace-nowrap rounded-lg text-sm font-medium ring-offset-background transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50',
  {
    variants: {
      variant: {
        default: 'bg-coffee-700 text-white hover:bg-coffee-800 active:bg-coffee-900',
        destructive: 'bg-red-500 text-white hover:bg-red-600',
        outline:
          'border-2 border-coffee-300 bg-transparent hover:bg-coffee-50 hover:border-coffee-400',
        secondary: 'bg-coffee-100 text-coffee-900 hover:bg-coffee-200',
        ghost: 'hover:bg-coffee-100 hover:text-coffee-900',
        link: 'text-coffee-700 underline-offset-4 hover:underline',
      },
      size: {
